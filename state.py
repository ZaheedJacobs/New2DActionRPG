...
class Scene(State):
    ...
    def draw(self, screen):
        ...
        self.debugger([f"Current player animation: {self.player.state}_{self.player.direction_status}", f"Direction vector: {self.player.direction}" , f"Dash vector: {self.player.mouse_vec}"])
